...
var getName:String = 'MUHAMMAD YASIR'
...
const famousPerson1:string = "Albert Einstein"
const famousQuote1:string = "Life is like riding a bicycle. To keep your balance, you must keep moving."

const messagE:string = `${famousPerson1} once said, ${famousQuote1}`
console.log(messagE)
//question 05
...
// Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
 ...
 var sum:string="Life is like riding a bicycle. To keep your balance, you must keep moving."
...
const friendNames3:string[] = ['Umer', 'Ahmed', 'Ali', 'Abubakar', 'Haris']

for(let i=0; i < friendNames.length; i++){
    const message4:string = `Hello ${friendNames3[i]}, Have a nice day. Stay Blessed <3 `;
...
const myVehicle1:string[] = ['Toyota' , 'Audi' , 'Ferrari' , 'BMW' , 'Honda']
...
const newGuests1:string[] = ['Shadab', 'Shaheen', 'Rauf','Naseem']
...
const frinds:string[] = ["Ahmed","Ali","Umer","Babar"]
...
let aliennColor:string = 'Green' || 'green'
...
let AliennColor2:string = 'Yellow' || 'yellow'
...
let aliennColor3:string = 'Red' || 'red'
...
var userName:string[] = ['admin' , 'Affan' , 'Babar' , 'Naseem','Shaheen','Rauf']
...
const currentUser: string[] = ['John', 'Alice', 'Bob', 'Jane', 'Eric'];
const newUser: string[] = ['John', 'Sara', 'David', 'ALICE', 'Grace'];
...
const favPizas:string[] = ["Fajita Pizza","Chicken Tikka Pizza","Chicken Malai Boti Pizza"]
...
function makeshirt2(size: string = "large", message: string = "I love Programming"): void {
